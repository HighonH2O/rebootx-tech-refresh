...
> Given an enterprise application's source code, discover everything that will be affected by a technology upgrade.

This module is responsible for understanding the repository **without executing it**.

---

# High-Level Goal

The Repository Scanner produces structured facts for the rest of RebootX.
